# cloud-itonami-iso3166-bra

Open ISO 3166 Blueprint for **BRA**: Brazil.
...
tax registration, and local-content rules in Brazil, so the operator
...
- **Not the government of Brazil.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Brazilian-licensed counsel
...
(ISO 3166 `BRA`). Required capabilities:
