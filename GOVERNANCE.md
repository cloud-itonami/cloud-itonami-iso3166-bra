...
`cloud-itonami-iso3166-bra` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Brazilian-licensed counsel or a registered agent for whatever licensed
representation the law of Brazil requires for public-procurement
filings.
